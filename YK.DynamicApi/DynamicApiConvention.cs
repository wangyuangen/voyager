...
using YK.DynamicApi.Enums;
using YK.DynamicApi.Helpers;
...
public class DynamicApiConvention : IApplicationModelConvention
{
    ...
    public void Apply(ApplicationModel application)
    {
        foreach (var controller in application.Controllers)
        {
            ...
            var DynamicApiAttr = Reflections.GetSingleAttributeOrDefaultByFullSearch<DynamicApiAttribute>(type.GetTypeInfo());
    ...
    {
        bool isExist = false;
        var noMapMethod = Reflections.GetSingleAttributeOrDefault<NonDynamicMethodAttribute>(action.ActionMethod);
    ...
    {
        bool isExist = false;
        var nonFormatResult = Reflections.GetSingleAttributeOrDefault<NonFormatResultAttribute>(action.ActionMethod);
    ...
    private void ConfigureSelector(string areaName, string controllerName, ActionModel action)
    {
        ...
        var nonAttr = Reflections.GetSingleAttributeOrDefault<NonDynamicApiAttribute>(action.ActionMethod);
